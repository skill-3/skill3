...
const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return (
    <div
      className={`flex flex-col grow px-10 pt-10 pb-28 w-full text-3xl font-bold leading-9 text-center ${backgroundColor} rounded-xl text-zinc-800 max-md:px-5 max-md:pb-24 max-md:mt-8`}
    >
      <img
        loading="lazy"
        src={imageSrc}
      ...
      />
      <h3 className="mt-16 ml-5 max-md:mt-10">{title}</h3>
      {description && (
        <p className="mt-2 text-base font-medium leading-8 text-zinc-600 max-md:mr-0.5">
          {description}
        </p>
      )}
    </div>
