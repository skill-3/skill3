    ...
    <section className="flex flex-col ml-5 w-[42%] max-md:ml-0 max-md:w-full">
      <div className="flex flex-col mt-28 text-4xl font-bold text-black leading-[60px] max-md:mt-10 max-md:max-w-full">
        ...
        <div className="mt-12 max-md:mt-10 max-md:max-w-full">
          ...
          <div className="flex items-center mb-4">
            <label htmlFor="age" className="w-32 text-right">
              Age:
            </label>
            <input
              id="age"
          ...
          <div className="flex items-center mb-4">
            <label htmlFor="school" className="w-32 text-right">
              School:
            </label>
            <input
              id="school"
          ...
          <div className="flex items-center mb-4">
            <label htmlFor="passion" className="w-32 text-right">
              Passion:
            </label>
            <input
              id="passion"
          ...
          <button
            ...
            className="px-16 pt-10 pb-20 w-full text-4xl font-bold text-black whitespace-nowrap bg-green-100 rounded-[50px] max-md:px-5 max-md:mt-10"
          >
            EDIT
          </button>
        </div>
