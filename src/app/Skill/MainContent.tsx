...
const MainContent: React.FC<MainContentProps> = ({ children }) => {
  ...
  const trendingSkills = [
    {
      title: "Find service ,hire expert",
      imageSrc:
  ...
  return (
    <main className="flex flex-col ml-5 w-[77%] max-md:ml-0 max-md:w-full">
      <div className="flex flex-col mt-2.5 w-full max-md:mt-6 max-md:max-w-full">
        <SearchBar />
        <SkillSection title="Explore new skills" skills={exploreSkills} />
        <SkillSection title="Trending Skills" skills={trendingSkills} />
