...
const Sidebar: React.FC = () => {
  const { wallet, isLoading, isError, address } = useWallet();
  ...
  return (
    <nav className="flex flex-col items-start pt-1 pb-24 w-64 bg-slate-900 overflow-y-auto max-h-screen">
      ...
      <h1 className="text-3xl tracking-tight text-zinc-100 ml-4 mt-4 font-display">
        Skill³
      </h1>
      <div className="flex flex-col w-full text-lg font-medium">
        ...
        />
        <SidebarItem
          icon="https://cdn.builder.io/api/v1/image/assets/TEMP/17480d4b45f5c452b6192a14787901294607cfdd1667df6fb15b227a325a6ae8?placeholderIfAbsent=true&apiKey=c602e869c07a418cbb15b337898df55f"
          text="Logout"
        />
      </div>
    </nav>
