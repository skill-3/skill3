...
const EventCard: React.FC<EventCardProps> = ({
  ...
  <article className="flex overflow-hidden flex-col pb-4 mx-auto w-full text-blue-900 bg-white rounded-3xl border border-solid border-white border-opacity-20 shadow-[0px_4px_12px_rgba(0,56,140,0.1)] max-md:mt-7">
    <img
      loading="lazy"
      src={imageSrc}
      alt=""
    ...
    <div className="flex justify-between items-center mx-4 mt-5 max-md:mx-2.5">
      <div className="flex gap-4 self-stretch pr-9 my-auto rounded-lg min-w-[240px] w-[254px]">
        ...
        <div className="flex flex-col self-start">
          ...
          <div className="text-xs leading-none max-md:mr-2.5">
            {time} · {location}
          </div>
        </div>
      </div>
