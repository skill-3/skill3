...
const Pagination: React.FC = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-wrap gap-10 justify-between items-center px-6 py-3 w-full max-md:px-5 max-md:max-w-full">
        <div className="self-stretch my-auto text-sm leading-none text-slate-500">
          Showing <span className="font-medium">1</span> to{" "}
          <span className="font-medium">10</span> of{" "}
          <span className="font-medium">97</span> results
        </div>
        <div className="flex self-stretch my-auto min-w-[240px] w-[378px]">
          <button
          ...
          <span className="px-4 py-2.5 text-sm font-medium leading-none text-center whitespace-nowrap bg-white border border-solid border-zinc-200 text-slate-500">
            ...
          </span>
          <button className="px-4 py-2.5 text-sm font-medium leading-none text-center whitespace-nowrap bg-white border border-solid border-zinc-200 text-slate-500">
            8
